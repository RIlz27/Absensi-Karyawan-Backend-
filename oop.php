...
//Class adalah cetak biru (blueprint) dari objek. Di kode kamu, ini adalah struktur utamanya.
//Ini mendefinisikan sebuah kelas bernama AbsensiController yang berisi semua logika untuk fitur absensi.
class AbsensiController extends Controller
{
    ...
    public function scan(Request $request)
    {
        ...
        //Object/Instance
        //Object adalah wujud nyata dari sebuah Class yang sudah dibuat 
        //menggunakan kata kunci new atau melalui resolusi otomatis Laravel.
        $now = Carbon::now();
